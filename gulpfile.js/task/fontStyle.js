...
const fontStyle = () => {
  ...
  let fontsFile = $.path.fontStyle.file;
  ...
  fs.readdir($.path.font.dest, function(err, fontsFiles){
      if(fontsFiles) {
          ...
          if(!fs.existsSync(fontsFile)) {
              ...
              console.log($.chalk `{bold {bgYellow.black ВНИМАНИЕ:}} Файл {magenta ${$.path.fontStyle.file}} уже существует. Для обновления файла нужно его удалить!`);
          }
      }
  });
